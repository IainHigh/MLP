...
processed_train_csv_path = "./Datasets/processed_train_df.csv"
processed_val_csv_path = "./Datasets/processed_val_df.csv"
processed_test_csv_path = "./Datasets/processed_test_df.csv"
...
def main():
    ...
    if not preprocessed:
        # preprocess data
        processed_train_df, processed_val_df, processed_test_df, words = preprocess_data(train_csv_path, val_csv_path, test_csv_path, mod_book_csv_path)
